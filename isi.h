...
char *akunATM, akun1[]="Alfarrel", akun2[]="Bagus";
int pin, pin1 = 100200, pin2 = 111000;
unsigned long long int saldo = 0, saldo1 = 2500000, saldo2 = 5000000;
unsigned long long int rek = 0, rek1 = 2211171010, rek2 = 2210171045, tmp = 0;
...
void konfirmasi()
{
        ...
        printf("\n                           	    TRANSAKSI BERHASIL!\n");
        printf(" 			TERIMAKASIH,TETAP JAGA PROTOKOL KESEHATAN ");
        cekSaldo();
